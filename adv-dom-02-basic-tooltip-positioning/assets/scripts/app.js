...
class App {
  static init() {
    ...
    // this.startAnalytics();
    //it will not pause any execution when the timer expires the startAnalytics function will call and it will register in stack.
  ...
  static startAnalytics(){
    ...
    as.src='assets/scripts/analytics.js';
    as.defer=true;
